...
class FindBusinesses extends Component {
        ...
        rows: [
                ...
                {
                    "id": 58594,
                    "name": "Broadway 25 Cap",
                    "slug": "broadway-25-cap-2",
                    "state": "CA",
                    "city": "Los Angeles",
                    "type": "dispensary",
                    "wmid": 512261198,
                    "latitude": 33.93,
                    "longitude": -118.27,
                    "web_url": "https://weedmaps.com/dispensaries/broadway-25-cap-2",
                    "package_level": "listing_plus",
                    "feature_order": 1,
                    "ranking": 3.65310487183688,
                    "rating": 5,
                    "reviews_count": 8,
                    "avatar_image": {
                    ...
                    "license_type": "medical",
                    "address": "13017 South Broadway",
                    "distance": 3609.782433423898,
                    "zip_code": "90061",
                    "timezone": "America/Los_Angeles",
                    "intro_body": "<p>ADDRESS: 13017 S. BROADWAY LOS ANGELES, CA 990061</p> <p>RECREATIONAL/MEDICAL</p> <p>PROP 64 21+without rec welcome!</p> <p>18+ bring your rec!!</p> <p>Please bring ID everytime, no ID no entry</p> <p>!!!ADD US ON INSTAGRAM && SNAPCHAT!!!</p> <p>IG: BROADWAY25CAP</p> <p>SNAP: BROADWAY25CAPP</p>",
                    "static_map_url": "https://staticmap.weedmaps.com/static_map/13/33.93/-118.27/402/147/map.png",
                    "open_now": true,
                    "closes_in": 277,
                    "todays_hours_str": " 8:00am - 11:45pm",
                    "min_age": 0,
                    "menu_items_count": 85,
                    "verified_menu_items_count": 49,
    ...
    componentDidMount () {
        ...
        axios.get( 'https://mit-location-svc.cfapps.io/api/v1/near?long=-118.291209&lat=33.957239&radius=100000' )
            .then( res => {
                ...
                this.setState( { rows: res.data.locations } );
                console.log( {rows} );
            } )
            .catch( error => {
                console.log( "error" );
